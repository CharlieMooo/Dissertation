...
to compare-items
  ...
  set temp-average-original-p average-original-p
  ...
  set temp-sellers (count items-s with [type-s = temp-type-d and volume-s = temp-volume-d and original-p <=  temp-average-original-p * (1 + 1 / (temp-average-original-p ^ (1 / 3))) and original-p >=  temp-average-original-p * (1 - 1 / (temp-average-original-p ^ (1 / 3)))])
  ...
  if any? items-s with [type-s = temp-type-d and volume-s = temp-volume-d and original-p = temp-average-original-p] [ask n-of temp-sellers items-s with [type-s = temp-type-d and volume-s = temp-volume-d and original-p = temp-average-original-p] [
...
;; Sellers Can Respond Purchase

to response-purchase
  set temp-type type-s
  set temp-volume-d volume-s
  set temp-average-original-p original-p
  if any? items-d with [type-d = temp-type and volume-d = temp-volume-d and average-original-p = temp-average-original-p] [ask one-of items-d with [type-d = temp-type and volume-d = temp-volume-d and average-original-p = temp-average-original-p] [
    set browse-number browse-number + 1
    ask myself [
      confirm-available-delivery-method
      confirm-highest-utility
...
to decide-to-buy
  ...
  if any? items-s with [type-s = temp-type-d and volume-s = temp-volume-d and original-p = temp-average-original-p] [
    ask max-one-of items-s with [type-s = temp-type-d and volume-s = temp-volume-d and original-p = temp-average-original-p] [utility] [
...
Based on the basic model, this model added the function that sellers can browse and respond inquiry of consumers actively every day. The consumers responded will decide to buy or not depending on the utility.
